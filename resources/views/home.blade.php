...
@section('pageContent')
    <div class="swiggity">
        <div class="big-gray">
            <div class="content-block">
                <img src="/images/headline1.jpg" alt="Why Choose Bennett Group?" class="main-headline" />
    ...
    <div class="big-light">
        <div class="content-block content-section">
            <img src="/images/headline2.jpg" alt="Available Services" />
            <div class="row">

                <div class="column-50">
                    <div class="row">
                        <div class="column-50">
                            <img src="/images/service1.jpg" alt="Human Resources" />
                        </div>
                        <div class="column-50">
                            <img src="/images/service2.jpg" alt="Marketing" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="column-50">
                            <img src="/images/service3.jpg" alt="Graphic Design" />
                        </div>
                        <div class="column-50">
                            <img src="/images/service4.jpg" alt="IT Services" />
                        </div>
                    </div>
                </div>
                <div class="column-50">
                    <div class="column-50">
                        <img src="/images/service5.jpg" alt="Legal Services" />
                    </div>
                    <div class="column-50">
                        <img src="/images/service6.jpg" alt="Tissue & Biofluid" />
                        <img src="/images/service7.jpg" alt="Clinical Trials" />
                    </div>
